...
module fabm_niva_brom_manganese
  ...
  type,extends(type_base_model),public :: type_niva_brom_manganese
    ...
    type(type_diagnostic_variable_id):: id_Wmn_var
  ...
  subroutine initialize(self,configunit)
    ...
    call self%get_parameter(&
         self%WMe,'WMe','[1/day]',&
         'Rate of accelerated sinking of particles with settled Mn hydroxides',&
         default=16.0_rk)
    call self%get_parameter(&
         self%Wmn_par,'Wmn_par','[1/day]',&
         'Total accelerated sinking of Mn hydroxides as a parameter',&
         default=16.0_rk)
    ...
    call self%register_state_variable(&
         ...
         minimum=0.0_rk,vertical_movement=-self%Wmn_par/86400._rk)
    call self%register_state_variable(&
  ...
  subroutine do(self,_ARGUMENTS_DO_)
    ...
    _LOOP_BEGIN_
      ...
      Wmn_var = self%WMe+self%WMe*Mn4/(Mn4+0.1_rk)
      ...
      _SET_DIAGNOSTIC_(self%id_Wmn_var, Wmn_var)
    _LOOP_END_
  end subroutine do
  !
  !
  ...
  subroutine get_vertical_movement(self, _ARGUMENTS_GET_VERTICAL_MOVEMENT_)
     ...
     real(rk) :: Wmn_var, Wmn_par
          
     _LOOP_BEGIN_
      
      Wmn_par = Wmn_var 

      _ADD_VERTICAL_VELOCITY_(self%id_Mn4, Wmn_par)
      _ADD_VERTICAL_VELOCITY_(self%id_MnS, Wmn_par)
      _ADD_VERTICAL_VELOCITY_(self%id_MnCO3, Wmn_par)
